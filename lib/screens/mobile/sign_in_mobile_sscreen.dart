...
class SignInMobileScreen extends GetView{
  ...
  // Constructor
  SignInMobileScreen({super.key,required TextEditingController emailController,required TextEditingController passwordController}){
